...

{
    ...
    public function createBookingNew($user_id)
...

    {
        ...
        $ids =DB::table('users')->where('id', $has->buyer)->pluck('fcm_token')->toArray();
       ...
       $firebaseToken =$ids;
        ...
        $data = [
            ...
            "notification" => [
                "title" => "ClickNBook",
                "body" =>"Your Booking Set To ".$status,  
            ]
        ];
