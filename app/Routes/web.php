...
Route::group(['prefix' => Config::get('awebooking.prefix_dashboard'), 'middleware' => ['authenticate', 'locale']], function () {
    ...
    Route::get('categories/{page?}', 'CategoryController@getCategories')->name('categories');
    Route::post('add-new-category', 'CategoryController@_addNewCategory')->name('add-new-category');

    Route::post('update-category', 'CategoryController@_updateCategory')->name('update-category');
    Route::post('get-category-item', 'CategoryController@_getCategoryItem')->name('get-category-item');
...
// Notification
    ...
    Route::post(Config::get('awebooking.after_checkout_slug'), 'CheckoutController@_thankyouPage');
    ...
    Route::get('chat','ChatController@chatting');
    Route::get('index','ChatController@index');
    Route::get('add-new-message','ChatController@add_message');

    Route::get('page/{page_id}/{page_slug?}', 'PageController@viewPage');
    ...
    Route::get('post/{post_id}/{post_slug?}', 'PostController@viewPost');



    Route::get('blog/{page?}', 'PostController@viewBlog');



    Route::get('category/{term_slug}/{page?}', 'PostController@viewCategory');



    Route::get('tag/{term_slug}/{page?}', 'PostController@viewTag');
    ...
    Route::get('/refund-policy' , 'HomePageController@refund_policy')->name('refund-policy-page');
...
// Contact page
    ...
    Route::get('contact-us', 'HomePageController@_contactPage');
    ...
    Route::get('become-a-host', 'UserController@_becomeAHost');



    Route::post('become-a-host', 'UserController@_becomeAHostPost');



    Route::get('welcome-user/{return}', 'UserController@_afterRegisterPartner');
...
Route::post('checkout{user_id?}', 'CheckoutController@_checkoutAction');
