...
<h2 class="h3 mt-4 mb-3">{{__('Cancalations Policy')}}</h2>
    ...
    <div class="row">
            ...
            <div class="col-12 col-md-4">
                ...
                <div class="hh-blog-item style-2">
                     ...
                     <img src="{{asset('images/pngwing.com.png')}}" height="200px" >
  
                        <div class="font-weight-bold category">{{__('Policy Type')}}
...
<div class="hh-blog-item style-2">
                    ...
                    <img src="{{asset('images/moderate.png')}}" height="200px" >
...
<div class="col-12 col-md-4">
                ...
                <img src="{{asset('images/flexible.png')}}"  height="200px" >
