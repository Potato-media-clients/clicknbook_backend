...
@if(!empty($Error_message))
            <div class="mt-4">
                ...
                @include('common.alert', ['type' => 'danger', 'message' => $Error_message])
                        ...
                        <div class="card-box card-border mt-3">
                            ...
                            <div class="tab-content">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" name="firstName" id="co-firstname"
                                                           ...
                                                           <input type="hidden" name="webView" 
                                                                value="{{$webView}}">
                                                                @if($user_id != 0)
                                ...
                                <div class="tab-pane relative" id="co-payment-selection">
                                    ...
                                    <form id="checkout-payment-info" action="{{ url('pay') }}"
                                        ...
                                        <div class="payment-gateways">
                                            ...
                                            @include('common.loading')
                                                    ...
                                                    <div class="payment-item payment-MontyPay">

                                                        <div class="radio radio-success mb-1 mb-md-3 d-flex align-content-center">

                                                            <input id="payment-MontyPay" class="payment-method" type="radio" name="MontyPay" value="MontyPay">

                                                            <label for="payment-MontyPay">Monty Pay</label>

                                                        </div>
                                                       
                                                            <div class="payment-desc">Credit Card Payment</div>


                                                        <img  src="https://clicknbook.co/storage/u-169/2022/12/18/montypaynewlogo-1-800x600-1671366200.png" alt="MontyPay"
