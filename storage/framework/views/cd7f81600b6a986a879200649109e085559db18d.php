...
<div id="setting-<?php echo e($idName); ?>" data-condition="<?php echo e($condition); ?>"
    ...
    <div class="col col-sm-6">
        ...
        <div class="form-group">
            ...
            <?php $__currentLoopData = $langs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>   
            <select  class="form-control hh-country <?php echo e(get_lang_class($key, $item)); ?>"  value="<?php echo e(get_translate($value['country'], $item)); ?>" name="<?php echo e($id); ?>[country]<?php echo e(!empty($item) ? '['. $item .']' : ''); ?>" id="<?php echo e($idName); ?>_country<?php echo e(get_lang_suffix($item)); ?>">
...
<?php /**PATH /home/potatoco/public_html/clicknbook.co/app/Views/options/fields/location.blade.php ENDPATH**/ ?>