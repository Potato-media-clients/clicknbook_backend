...
<div id="setting-<?php echo e($idName); ?>" data-condition="<?php echo e($condition); ?>"
    ...
    <div class="checkbox-wrapper">
        <?php if(!empty($choices)): ?>
            ...
            <?php endif; ?>
        <?php endif; ?>
        <input class="checkbox-value" type="hidden" name="<?php echo e($id); ?>" value="<?php echo e(implode(',', $value)); ?>">
    </div>
</div>
<?php if($break): ?>
    <div class="w-100"></div> <?php endif; ?>
<?php /**PATH /home/potatoco/public_html/clicknbook.co/app/Views/options/fields/checkbox_pro.blade.php ENDPATH**/ ?>