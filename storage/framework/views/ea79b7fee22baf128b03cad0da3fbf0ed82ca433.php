            ...
            <form class="form form-action form-add-term-modal form-translation"
                ...
                <div class="modal-body relative">
                    ...
                    <div class="form-group">
                        ...
                        <label for=""><?php echo e(__('All Categories')); ?></label>
                        <?php $__currentLoopData = $langs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $categories = App\Models\Category::get();
                            ?>
                            <select type="text" class="form-control has-validation <?php echo e(get_lang_class($key, $item)); ?>"

                                data-validation="required" id="term_name<?php echo e(get_lang_suffix($item)); ?>"

                                name="category_id" <?php if(!empty($item)): ?> data-lang="<?php echo e($item); ?>"

                                <?php endif; ?>

                                placeholder="<?php echo e(__('Name')); ?>">
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item1->id); ?>"><?php echo e(get_translate($item1->name, $item)); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /home/potatoco/public_html/clicknbook.co/app/Views/dashboard/screens/administrator/services/home/quick-add-home-amenity.blade.php ENDPATH**/ ?>