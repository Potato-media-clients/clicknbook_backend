        ...
        <div class="content">
            ...
            <?php else: ?>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8">
                        ...
                        <div class="card-box">
                            ...
                            <?php echo \ThemeOptions::renderMeta('home_settings', $serviceObject , true, dashboard_url('post-new-home'), 'my-home'); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8" hidden>
...
<?php /**PATH /home/potatoco/public_html/clicknbook.co/app/Views/dashboard/screens/administrator/services/home/add-new-home.blade.php ENDPATH**/ ?>