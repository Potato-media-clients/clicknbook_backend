...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            <?php echo $__env->make('dashboard.components.breadcrumb', ['heading' => __('Categories')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <table class="table table-large mb-0 dt-responsive nowrap w-100" data-plugin="datatable"
                        ...
                        <?php $__currentLoopData = $allTerms['results']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="align-middle force-show">
                                    <h5 class="m-0">
                                        <a href="<?php echo e(get_term_link($item->term_name)); ?>" target="_blank">
                                    ...
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a href="javascript:void(0)" class="dropdown-item" data-toggle="modal"
                                               ...
                                               data-target="#hh-update-post-categories-modal"><?php echo e(__('Edit')); ?></a>
                    ...
                    <?php else: ?>
                        <tr>
                            ...
                            <td class="d-none"></td>
                            <td colspan="12">
                                <h4 class="mt-3 text-center"><?php echo e(__('No categories yet.')); ?></h4>
                            </td>
                        </tr>
                    <?php endif; ?>
                    </tbody>
            ...
            <div id="hh-update-post-categories-modal" class="modal fade hh-get-modal-content" tabindex="-1"
                 ...
                 data-url="<?php echo e(dashboard_url('get-post-category-item')); ?>">
                    ...
                    <div class="modal-content">
                        <form class="form form-action form-update-term-modal relative form-translation"
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title"><?php echo e(__('Update Category')); ?></h4>
...
<?php /**PATH /home/potatoco/public_html/clicknbook.co/app/Views/dashboard/screens/administrator/services/post/post-category.blade.php ENDPATH**/ ?>