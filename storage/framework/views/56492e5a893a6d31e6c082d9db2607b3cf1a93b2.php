...
<head>
    ...
    <title><?php echo e(__('Page Not Found')); ?></title>

    <link href="<?php echo e(asset('css/vendor.min.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('css/main.min.css')); ?>" rel="stylesheet" type="text/css">
</head>
            ...
            <div class="col-lg-5">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="error-ghost text-center">
                            <svg class="ghost" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                 xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="127.433px"
                                 height="132.743px"
                                 viewBox="0 0 127.433 132.743" enable-background="new 0 0 127.433 132.743"
                                 xml:space="preserve">
                        ...
                        <div class="text-center">
                            <h3 class="mt-4"><?php echo e(__('Page not found')); ?> </h3>
                            <p class="text-muted mb-0"><?php echo e(__("It's looking like you may have taken a wrong turn. Don't worry... it happens to the best of us. You might want to check your internet connection. Here's a little tip that might help you get back on track.")); ?></p>
                        </div>
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        <p><?php echo e(__('Return to')); ?> <a href="<?php echo e(url('/')); ?>" class="ml-1"><b><?php echo e(__('Home page')); ?></b></a></p>
                    </div> <!-- end col -->
                </div>
                <!-- end row -->
...
<?php /**PATH /home/potatoco/public_html/clicknbook.co/app/Views/frontend/404.blade.php ENDPATH**/ ?>