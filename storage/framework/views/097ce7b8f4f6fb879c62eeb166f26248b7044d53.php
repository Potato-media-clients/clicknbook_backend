...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            <?php echo $__env->make('dashboard.components.breadcrumb', ['heading' => __('Posts')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="card-box card-list-post">
                ...
                <div class="action-toolbar">
                    <form class="hh-form form-inline" action="<?php echo e(dashboard_url('post-bulk-actions')); ?>"
                ...
                <table id="table-my-post" class="table table-large mb-0 dt-responsive nowrap w-100 hh-list-service"
                    ...
                    <tbody>
                    <?php if($allPosts['total']): ?>
                        <?php $__currentLoopData = $allPosts['results']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                    ...
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h5 class="m-0 title-overflow">
                                                <a class="text text-overflow" href="<?php echo e(get_the_permalink($item->post_id, $item->post_slug, 'post')); ?>"
                                                   target="_blank">
                                            ...
                                            <div class="quick-action-links d-none d-md-block">
                                                <a class="quick-link-item" target="_blank"
                                                   href="<?php echo e(url('dashboard/edit-post/' . $item->post_id )); ?>"><?php echo e(__('Edit')); ?></a>
                                                <?php if($item->status != 'trash'): ?>
                                                    ...
                                                    <a class="quick-link-item quick-link-item-trash hh-link-action hh-link-change-post-status"
                                                       data-action="<?php echo e(dashboard_url('change-post-status')); ?>"
                                                       data-parent="tr"
                                                    ...
                                                    <?php if($item->status == 'publish'): ?>
                                                        <a class="quick-link-item"
                                                           href="<?php echo e(get_the_permalink($item->post_id, $item->post_slug, 'post')); ?>"
                                ...
                                <td class="align-middle text-center">
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a href="<?php echo e(url('dashboard/edit-post/' . $item->post_id )); ?>"
                                            ...
                                            <a class="dropdown-item hh-link-action hh-link-delete-post text-danger"
                                               data-action="<?php echo e(dashboard_url('delete-post-item')); ?>"
                                               data-parent="tr"
                                               data-is-delete="true"
                                               data-params="<?php echo e(base64_encode(json_encode($data))); ?>"
                                               data-confirm="yes"
                                               data-confirm-title="<?php echo e(__('Confirm Delete')); ?>"
                                               data-confirm-question="<?php echo e(__('Are you sure want to delete this post?')); ?>"
                    ...
                    <?php else: ?>
                        <tr>
                            ...
                            <td class="d-none"></td>
                            <td colspan="7">
                                <h4 class="mt-3 text-center"><?php echo e(__('No posts yet.')); ?></h4>
                            </td>
                        </tr>
                    <?php endif; ?>
                    </tbody>
                ...
                <div class="clearfix mt-2">
                    <?php echo e(dashboard_pagination(['total' => $allPosts['total']])); ?>
...
<?php /**PATH /home/potatoco/public_html/clicknbook.co/app/Views/dashboard/screens/administrator/services/post/post.blade.php ENDPATH**/ ?>